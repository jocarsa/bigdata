...
def calcula(minota1,minota2,modulo):
...
entrada2.pack()
tk.Label(marco,text="Introduce el módulo formativo").pack()
entrada3 = tk.Entry(marco,textvariable=var3)
entrada3.pack()
